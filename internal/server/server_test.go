...
import (
	...
	"github.com/blackmax1886/proglog/internal/auth"
	"github.com/blackmax1886/proglog/internal/config"
	"github.com/blackmax1886/proglog/internal/log"
...
var debug = flag.Bool("debug", false, "Enable obserbility for debugging.")
...

	{
		...
		for offset, record := range records {
			...
			if res.Offset != uint64(offset) {
				t.Fatalf("got offsetL %d, want: %d", res.Offset, offset)
			}
		}
	}
